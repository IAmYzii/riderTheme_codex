...
ATTR_OVERRIDES.update({
    ...
    # errors / warnings
    "ERRORS_ATTRIBUTES": attr(effect=P.EMBER_RED, effect_type=2, stripe=P.EMBER_RED),
    ...
    "WRONG_REFERENCES_ATTRIBUTES": attr(fg=P.EMBER_BRIGHT, stripe=P.EMBER_RED, font=0),
    "RUNTIME_ERROR": attr(effect=P.EMBER_RED, effect_type=2, stripe=P.EMBER_RED),
